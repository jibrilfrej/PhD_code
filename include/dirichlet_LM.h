...
inline
double Dirichlet_language_model(const double &mu , const std::vector<std::string> &query , const std::vector<std::string> &document , const std::unordered_map <std::string,int>  &cf , const int collection_size){
...
std::unordered_map <int,double> Dirichlet_language_model(const double &mu , const std::vector<std::string> &query , const std::unordered_map< int , std::vector<std::string> > &collection , const std::unordered_map <std::string,int>  &cf , const int collection_size ){
...
std::vector< std::vector< std::pair<int,double> > > Dirichlet_language_model(const double &mu , const std::unordered_map< int , std::vector<std::string> > &queries , const std::unordered_map < int , std::vector<std::string> > &collection , const std::unordered_map <std::string,int>  &cf , const int k , const int collection_size){
