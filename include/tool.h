...
double fast_cos(const std::string &term1 , const std::string &term2 , const std::unordered_map< std::string , std::unordered_map<std::string,double> > &set_cos){
...
double fast_sum_proba_pairs(const std::string &term , const std::vector<std::string> &set , const std::unordered_map< std::string , std::unordered_map<std::string,double> > &cosine_map){
...
double translation_proba(const std::string &term1 , const std::string &term2 , const std::unordered_map<std::string , double> &sum_cosine_map , const std::unordered_map< std::string , std::unordered_map<std::string,double> > &cosine_map ){
...
double proba_doc_generate_term(const std::string &term , const std::vector<std::string> &document , const std::unordered_map<std::string , double> &sum_cosine_map , const std::unordered_map< std::string , std::unordered_map<std::string,double> > &cosine_map ){
...
double proba_doc_generate_term(const std::string &term , const std::vector<std::string> &document , const std::unordered_map<std::string , double> &sum_cosine_map , const std::unordered_map< std::string , std::unordered_map<std::string,double> > &cosine_map , const double &alpha ){
